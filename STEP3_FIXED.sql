-- ==================================================
-- ETAPA 3 CORRIGIDA: CRIAR ÍNDICES E FUNÇÕES
...
-- CORRIGIDO: referência correta à coluna metric_date
...
DO $$
BEGIN
    RAISE NOTICE '✅ ETAPA 3 CORRIGIDA CONCLUÍDA: Índices, funções e triggers criados';
END $$;