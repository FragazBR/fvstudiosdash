-- ==================================================
-- MIGRAÇÃO INCREMENTAL - SISTEMA INTELIGENTE
-- Integração que PRESERVA todos os dados existentes
-- ==================================================

-- ETAPA 1: VERIFICAR ESTRUTURA ATUAL
DO $$
BEGIN
    RAISE NOTICE '🔍 VERIFICANDO ESTRUTURA ATUAL DO BANCO...';
END $$;
...
WHERE schemaname = 'public' 
    AND tablename IN ('projects', 'tasks', 'contacts', 'user_profiles', 'agencies')
ORDER BY tablename;

-- ETAPA 2: ADICIONAR CAMPOS FALTANTES ÀS TABELAS EXISTENTES
...
-- ETAPA 3: CRIAR TABELAS DO SISTEMA INTELIGENTE
...
CREATE TABLE IF NOT EXISTS project_templates (
    ...
    description TEXT,
    category VARCHAR(50) NOT NULL, -- 'web_development', 'mobile_app', 'branding', 'marketing'
    color VARCHAR(7) DEFAULT '#3B82F6',
    icon VARCHAR(50) DEFAULT 'folder',
    estimated_duration INTEGER DEFAULT 30, -- dias
...
-- 6. Notificações inteligentes (expandindo a existente)
...
-- ETAPA 5: CRIAR FUNÇÕES INTELIGENTES
...
-- ETAPA 7: INSERIR TEMPLATES PADRÃO
...
-- ETAPA 8: ATUALIZAR PROJETOS EXISTENTES
...
-- ETAPA 9: CRIAR VIEWS PARA COMPATIBILIDADE
...
-- ETAPA 10: MENSAGENS DE SUCESSO

DO $$
BEGIN
    RAISE NOTICE '✅ MIGRAÇÃO INCREMENTAL CONCLUÍDA COM SUCESSO!';
    ...
    RAISE NOTICE '   - Templates de projeto automáticos';
    RAISE NOTICE '   - Geração automática de etapas e tarefas';
    RAISE NOTICE '   - Cálculo automático de health score';
    RAISE NOTICE '   - Sistema de métricas e analytics';
