-- ==================================================
-- ADICIONAR COLUNA CONTRACT_VALUE À TABELA CLIENTS
-- Informação importante para o workstation
-- ==================================================
...
-- 5. Ver estrutura atual da tabela clients (informações adicionais)
SELECT 
    table_name,
    column_name,
    data_type,
...
-- ==================================================
-- AGORA A TABELA CLIENTS TERÁ INFORMAÇÕES FINANCEIRAS
-- Execute este script antes do CRIAR_PERFIS_USUARIOS.sql
-- ==================================================