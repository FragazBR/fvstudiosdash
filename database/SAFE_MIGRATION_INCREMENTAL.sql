-- ==================================================
-- SAFE INCREMENTAL MIGRATION - Handles Existing Objects
...
-- ==================================================
-- 1. SAFE CLEANUP - Only drop what doesn't exist
-- ==================================================
...
-- ==================================================
-- 3. CREATE MISSING INDEXES SAFELY
-- ==================================================
...
-- ==================================================
-- 4. CREATE UPDATE FUNCTION SAFELY
-- ==================================================
...
RAISE NOTICE '✅ Created/updated function: update_updated_at_column';

-- ==================================================
-- 5. CREATE TRIGGERS SAFELY (avoiding duplicates)
-- ==================================================
